...
\item \begin{tabular}
		$u\sfrac{3}{4}\lambda s_2\lambda (s_1\longdivision{s_2}) uv$ & and also \\
	$u\sfrac{3}{4}\lambda s_2v (s_1\longdivision{s_2})$ & $u\equiv s_2$ \\
\end{tabular}
...
\item \begin{tabular}
		$u\sfrac{3}{4}\lambda$ & \begin{tabular}
			$s_2\lambda (s_1\overbrace{s_2}) u\overbracket{s_1s_2}$ \\ \midrule
			$s_2v (s_1\overbrace{s_2}) u^\infty s_2$ \\
		\end{tabular}
\end{tabular}

\item \begin{tabular}
		$u\sfrac{3}{4}\lambda$ & \begin{tabular}
			$s_2\lambda (s_1\supset s_2) u\equiv s_2$ \\ \midrule
			$s_2 v (s_1\supset s_2) u\overbracket{s_1s_2}$ \\
		\end{tabular}
\end{tabular}
