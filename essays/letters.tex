...
\signoff{Best regards,}\signoff{Bob Morris}
...
\begin{tabular}{ c c c c c }	\redact{Jazz} & 	\redact{Cage} & 	\redact{"Folk Music"} & 	\redact{Communism} & 		\begin{tabular}{ c }			(anti-art?) \\			----------------- \\			(communism) \\		\end{tabular} \\\end{tabular}\\\noindentI've been along this road too. \\Yes I certainly do see the harmfullness of serious culture. My favorite movies are plain documentaries. 
...
\vfill\noindent I think you were right in not giving examples! \\\vfill\noindent however \\your absolute---statements and "come on"---and blend with the communist ideas---(My mind was pretty tired by then and I didn't follow how the veramusement---was tied to communism)---this \textsc{it} kind of talk.---can only shoo people off---and let them wait for the next revision or explication. 
